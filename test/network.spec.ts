import { DefaultLinkFunction, Link, LinkFunction } from "../src/types/link";
...
describe("Network Tests", () => {
    it("should create simple network and iterate", () => {
        ...
        link1.AddFunc(DefaultLinkFunction);

        link2.AddFunc(DefaultLinkFunction);
    ...
    it("should create simple divering network and iterate", () => {
        ...
        link1.AddFunc(DefaultLinkFunction);
        link2.AddFunc(DefaultLinkFunction);
        link3.AddFunc(DefaultLinkFunction);
        link4.AddFunc(DefaultLinkFunction);
    ...
    it("very long single pipe network divering network and iterate", () => {
        ...
        link3.AddFunc(DefaultLinkFunction);
        link4.AddFunc(DefaultLinkFunction);
        link5.AddFunc(DefaultLinkFunction);
    ...
    it("very very long single pipe network divering network and iterate", () => {
        ...
        link4.AddFunc(DefaultLinkFunction);
        link5.AddFunc(DefaultLinkFunction);
        link6.AddFunc(DefaultLinkFunction);
